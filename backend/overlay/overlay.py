...
def burn_subtitles_from_paths(video_path: str, srt_path: str, style_json: str, output_path: str):
    """
    Burn subtitles onto video using file paths (for pipeline compatibility)
    """
    try:
